...
void Game::Init()
{
	...
	AddGameObject<Goal>(1)->SetPosition(D3DXVECTOR3(-20.0f, 0.0f, 30.0f));
	...
	*/
	...
	cylinder->SetScale(D3DXVECTOR3(8.0f, 4.0f, 8.0f));

	{
		...
		box10->SetPosition(D3DXVECTOR3(0.0f, -1.0f, 30.0f));
		...
		box17->SetPosition(D3DXVECTOR3(20.0f, -1.0f, -10.0f));
		...
		box19->SetPosition(D3DXVECTOR3(0.0f, -1.0f, -10.0f));
		box19->SetScale(D3DXVECTOR3(5.0f, 2.0f, 5.0f));

		Box* box20 = AddGameObject<Box>(1);
		box20->SetPosition(D3DXVECTOR3(-10.0f, -1.0f, -10.0f));
		box20->SetScale(D3DXVECTOR3(5.0f, 2.0f, 5.0f));

		Box* box21 = AddGameObject<Box>(1);
		box21->SetPosition(D3DXVECTOR3(-20.0f, -1.0f, -10.0f));
		box21->SetScale(D3DXVECTOR3(5.0f, 2.0f, 5.0f));
	}*/

	Player* player = AddGameObject<Player>(1);
	player->SetPosition(D3DXVECTOR3(7.0f, 0.0f, -1.0f));

	//Child* child = AddGameObject<Child>(1);
	//child->SetPosition(D3DXVECTOR3(-1.0f, 0.0f, -4.0f));
	//child->SetParent(player);

	//AddGameObject<Enemy>(1)->SetPosition(D3DXVECTOR3(11.0f, 0.0f, 15.0f));
	//AddGameObject<Enemy>(1)->SetPosition(D3DXVECTOR3(-12.0f, 0.0f, 15.0f));

	// エネミーAの配置
	{
		EnemyA* enemyA0 = AddGameObject<EnemyA>(1);
		enemyA0->SetPosition(D3DXVECTOR3(0.0f + (50.0f * (rand() / (float)RAND_MAX)), 0.0f, 0.0f + (50.0f * (rand() / (float)RAND_MAX))));
	}
	// エネミーBの配置
	{
		EnemyB* enemyB0 = AddGameObject<EnemyB>(1);
		enemyB0->SetPosition(D3DXVECTOR3(0.0f + (50.0f * (rand() / (float)RAND_MAX)), 0.0f, 0.0f + (50.0f * (rand() / (float)RAND_MAX))));

		EnemyB* enemyB1 = AddGameObject<EnemyB>(1);
		enemyB1->SetPosition(D3DXVECTOR3(0.0f + (50.0f * (rand() / (float)RAND_MAX)), 0.0f, 0.0f + (50.0f * (rand() / (float)RAND_MAX))));


		EnemyB* enemyB2 = AddGameObject<EnemyB>(1);
		enemyB2->SetPosition(D3DXVECTOR3(0.0f + (50.0f * (rand() / (float)RAND_MAX)), 0.0f, 0.0f + (50.0f * (rand() / (float)RAND_MAX))));
	}
	...
	EnemyAState* enemyAState = AddGameObject<EnemyAState>(2);
...
void Game::Update()
{
	...
	if (Input::GetKeyTrigger('F') /*enemyA->GetKillCount() == 3  goal->GetGoal() == true*/)
	{
		m_Fade->FadeOut();
		SetMoveScene(0);
	}
